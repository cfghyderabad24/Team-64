  ...
  return (
    <div className="container ">
      <div className="text-center mb-4">
        ...
        <p>
          Make a difference by buying, donating products or helping a child in
          need.
        </p>
      </div>
          ...
          <div className="card shadow-sm">
            <div className="card-body">
              <button className="btn btn-primary btn-lg w-100">
                <Link to="/buy-products" className="p-4 text-dark">
                  Buy Products
                </Link>
              </button>
            </div>
          ...
          <div className="card shadow-sm">
            <div className="card-body">
              <button className="btn btn-success btn-lg w-100">
                <Link to="/donate-products" className="p-4 text-dark">
                  Donate Products
                </Link>
              </button>
            </div>
          ...
          <div className="card shadow-sm">
            <div className="card-body">
              <button className="btn btn-warning btn-lg w-100">
                <Link to="/donate-for-child" className="p-4 text-dark">
                  Donate For A Child
                </Link>
              </button>
            </div>
