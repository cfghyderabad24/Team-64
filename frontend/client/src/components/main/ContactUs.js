  ...
  return (
    <div>
      <div className="heading " style={{ marginTop: '2rem' }}>
        <h1 className="font-weight-bold text-dark ms-5">CONTACT US</h1>
      </div>
        ...
        <div className="row  container mx-auto">
          ...
          <div className="text col-lg-6 col-md-6 col-12 w-50">
            <div className="container mt-4" id="form-container">
              <h2 className="">Feel free to contact us using this form <i className="far fa-smile-beam"></i></h2>
              <form action="/contactus" className="r" method="post">
                ...
                <div className="form-group">
                  <label htmlFor="subject" className="text-primary me-1">Subject*</label>
          ...
          <div className="accordion" id="faqAccordion">
            <div className="card">
              <div className="card-header" id="headingOne">
                <h5 className="mb-0">
                  <button className="btn  dropdown-toggle" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            ...
            <div className="card">
              <div className="card-header" id="headingTwo">
                <h5 className="mb-0">
                  <button className="btn dropdown-toggle" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
